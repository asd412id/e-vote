        ...
        <div class="card-body bg-white text-dark">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" placeholder="Masukkan nama Kandidat" value="{{ old('name')??$data->name }}">
            </div>
            <div class="form-group">
              <label for="photo">Foto</label>
              <div class="photo-wrapper mb-3">
                <img src="{{ \Storage::disk('public')->url(@$data->opt['photo']) }}" width="100" alt="">
              </div>
