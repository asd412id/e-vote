        ...
        <div class="card-body bg-white text-dark">
          ...
          <form method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" placeholder="Masukkan Nama Lengkap" value="{{ old('name') }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" name="password" id="password" placeholder="Masukkan Password" value="{{ old('password') }}">
            </div>
            <div class="form-group">
              ...
              <select class="form-control" name="group" id="group">
                ...
                @foreach ($group as $key => $v)
                  <option {{ old('group')==$v->id?'selected':'' }} value="{{ $v->id }}">{{ $v->name }}</option>
                @endforeach
              </select>
            </div>
            <div class="form-group">
